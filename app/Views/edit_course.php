                ...
                <div class="page-content">
                    ...
                    <section class="section">
                        <div class="subtitle mb-3">
                            <h4><b>Edit Course: </b><?= $course['c_name'] ?></h4>
                        </div>
                        <form method="POST" action="<?= base_url('/course' . '/' . $course['c_id'] . '/update') ?>" enctype="multipart/form-data" onsubmit="validationForm()">
                            <?= csrf_field(); ?>
                            <div class="mb-3 row">
                                <label for="name" class="col-sm-2 col-form-label">Course Name</label>
                                <div class="col-sm-10">
                                    <input type="text" name="c_name" class="form-control" id="name" value="<?= !empty(old('c_name')) ? old('c_name') : $course['c_name'] ?>">
                                        ...
                                        <?php if (!empty($categories)) : ?>
                                            <?php foreach ($categories as $category) : ?>
                                                <?php if (!empty(old('category_id'))) : ?>
                                                    ...
                                                    <?php endif ?>
                                                <?php else : ?>
                                                    <?php if ($course['category_id'] == $category['category_id']) : ?>
                                                        <?php echo '<option value="' . $category['category_id'] . '" selected>' . $category['name'] . '</option>' ?>
                                                    <?php else : ?>
                                                        <option value="<?= $category['category_id'] ?>"><?= $category['name'] ?></option>
                                                    <?php endif ?>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="c_desc" id="desc" cols="30" rows="10"><?= !empty(old('c_desc')) ? old('c_desc') : $course['c_desc'] ?></textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php else : ?>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="paid_check" id="paid_check_yes" value="1" <?php if ($course['c_price'] > 0) : ?> <?= 'checked' ?> <?php endif ?>>
                                            <label class="form-check-label" for="paid_check_yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="paid_check" id="paid_check_no" value="0" <?php if ($course['c_price'] <= 0) : ?> <?= 'checked' ?> <?php endif ?>>
                                            <label class="form-check-label" for="paid_check_no">No</label>
                                        </div>
                                    <?php endif ?>
                                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" value="<?= !empty(old('c_price')) ? old('c_price') : $course['c_price'] ?>" name="c_price" class="form-control" id="price">
                            ...
                            <div class="mb-3 row">
                                ...
                                <p>Gambar Sebelumnya: <a href="<?= base_url('uploads/' . $course['c_id'] . '/' . $course['c_imagepath']) ?>" target="_blank" rel="noopener noreferrer">Click to preview</a></p>
                                <div class="col-sm-10">
