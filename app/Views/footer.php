...
<footer>
    <div class="p-5" style="background-color: rgba(1, 1, 1, 1)">
        ...
        <section style="text-align: center; ">
            <a href="#" class="btn btn-primary btn-floating m-2" style="background-color: #424242; border-color: #424242;" role="button">
        ...
        <section class="row justify-content-center p-2" style="text-align: center;">
        ...
        <section class="row justify-content-end p-2" style="text-align: right">
            <p style="color: white">
                <span>
                    <i class="far fa-copyright" style="color: white"></i>
                </span>Berbaring. 2022. Sinauno
            </p>
        </section>
    </div>
</footer>